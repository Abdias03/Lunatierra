...
export default function AdminAgricolaPage() {
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(220,231,199,0.55),_rgba(247,242,231,0.95)_32%,_#efe2cf_100%)] px-4 pb-16 pt-6 text-earth-900">
      <div className="mx-auto max-w-5xl space-y-6">
        ...
        <header className="space-y-2">
          ...
          <p className="max-w-2xl text-sm leading-6 text-earth-700">
            {t('admin.subtitle')}
          </p>
        </header>

        {error ? (
          <AppCard className="border-rose-200 bg-rose-50/95 p-4">
            <p className="text-sm text-rose-700">{error}</p>
          </AppCard>
        ) : null}

        {success ? (
          <AppCard className="border-leaf-200 bg-leaf-50/95 p-4">
        ...
        <section className="grid gap-6 lg:grid-cols-2">
          <AppCard className="bg-white/92 p-5">
