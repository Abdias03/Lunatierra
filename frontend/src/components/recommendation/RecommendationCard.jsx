export default function RecommendationCard({ title, message }) {
  return (
    <section data-testid="recommendation-card" className="recommendation-card relative overflow-hidden rounded-[30px] bg-[linear-gradient(145deg,_rgba(92,138,61,1)_0%,_rgba(62,97,40,1)_55%,_rgba(44,33,20,0.96)_100%)] px-5 py-6 text-white shadow-card">
