...
const { STAGE_PREFIX: STAGE_STORAGE_PREFIX } = STORAGE_KEYS;
...
export default function CropHeroPremium({ crop }) {
  ...
  return (
    <section
      data-testid="crop-hero-premium"
      className={`crop-hero-premium relative overflow-hidden rounded-[36px] bg-gradient-to-b ${gradient} px-5 pb-6 pt-5 text-white shadow-card`}
    >
      ...
      <div className="relative z-10">
        ...
        <div className="mt-2">
          <PlantVisual
            ...
            cropName={crop.cropDisplayName || crop.cropName}
            animateGrowth={showGrowthNudge}
          />
        </div>
