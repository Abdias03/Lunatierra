...
export default function CropTrackingListI18n({ crops }) {
      ...
      {crops.map((crop) => (
        <article key={crop.id} className="rounded-3xl bg-earth-50 p-4">
          <div className="flex items-start justify-between gap-4">
            <div>
              <h3 className="text-lg font-semibold capitalize text-earth-900">{t(`crop.names.${crop.cropName}`, crop.cropName)}</h3>
