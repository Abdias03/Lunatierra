...
export default function AssistantBubble({
  ...
  return (
    <AppCard className={`${tones[tone] || tones.leaf} p-4 shadow-[0_16px_30px_rgba(67,88,43,0.08)]`}>
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-start gap-3">
          <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-white/75 text-2xl shadow-[0_10px_20px_rgba(39,56,28,0.08)]">
