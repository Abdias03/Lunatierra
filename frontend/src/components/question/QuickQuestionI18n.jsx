...
export default function QuickQuestionI18n({ onAsk, loading, answer }) {
  ...
  const submit = async (event) => {
    ...
    console.log('QuickQuestion: Submitting question:', nextQuestion); setLastQuestion(nextQuestion);
    await onAsk(nextQuestion);
    console.log('QuickQuestion: Question submitted successfully'); setQuestion('');
  };

  return (
    <div data-testid="quick-question" className="quick-question space-y-5">
